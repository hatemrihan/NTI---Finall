         ...
         'Founded in 2024, NOMA was built on the appreciation for honest materials, refined geometry, and everyday utility. We believe the objects we carry define our daily space.',
              ...
              Text('Our Values', style: AppStyles.style20ExtraBold),
                SizedBox(height: 10),
                 ...
                 Expanded(
                  child: Text(' Handcrafted items created to endure across seasons.',
                  style: AppStyles.style13.copyWith(color: AppColors.grayClr)),
                          ), ],
           ),
             SizedBox(height: 10),
             Row(
          ...
          SizedBox(height: 70),
            Center(child: Text('NOMA Accessories • v1.4.0',
             style: AppStyles.style12.copyWith(color: AppColors.grayClr))),
