...
class ReviewCartDetails extends StatelessWidget {
  const ReviewCartDetails({super.key, required this.reviewerFirstLetter, required this.name, required this.date, required this.rating, required this.review});
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 8),
            Text(review,style: AppStyles.style13Regular.copyWith(color: AppColors.hintClr),
              maxLines: 5,
            ),
          ],
        ),
