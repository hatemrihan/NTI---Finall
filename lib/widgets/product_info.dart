...
class ProductInfo extends StatelessWidget {
  const ProductInfo({super.key, required this.image, required this.brand, required this.description, required this.price, required this.oldPrice, required this.rating, required this.reviews});
  final String image;
  final String brand;
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        SizedBox(height: 20,),
        Text(brand, style: AppStyles.style13Bold.copyWith(color: Color(0xff7B827A)),),
        SizedBox(height: 6,),
